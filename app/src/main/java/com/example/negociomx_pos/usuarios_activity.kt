...
class usuarios_activity : AppCompatActivity() {
            ...
            btnGuardarUsuarioAlta.setOnClickListener {
                ...
                if(nombreCompleto.isEmpty()==true)
                    ...
                    dalUsu.getUsuarioByEmail(email){
                        ...
                        if(res!=null)
                        {
                            bllUtil.MessageShow(this@usuarios_activity,"El correo ya existe en el Sistema",
                                "Aviso"){}
                        ...
                        else
                        {
                            ...
                            var usuario=UsuarioNube(IdEmpresa = idEmpresa, IdRol = idRol, NombreCompleto = nombreCompleto,
                                Email = email, CuentaVerificada = false, Password = contrasena,  Activo = activo)
                            dalUsu.insert(usuario){
                                    res->
                                limpiaControles()
                            }
    ...
    private fun muestraListaUsuarios() {
        dalUsu.getAllUsuarios(null,true){
            res, mensajeError ->
