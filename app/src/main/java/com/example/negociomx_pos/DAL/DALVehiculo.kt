...
// ✅ CONSULTAR VEHÍCULO POR VIN - CORREGIDO PARA ESQUEMA REAL
    ...
    suspend fun insertarPaso1LogVehiculo(
        ...
        idPasoNumLogVehiculoNotificacion:Int?=null
    ): Int = withContext(Dispatchers.IO) {
        var conexion: Connection? = null
        var statement: PreparedStatement? = null
        var statementNot: PreparedStatement? = null
        ...
        """.trimIndent()
            ...
            if (idPasoNumLogVehiculoNotificacion!=null && idPasoNumLogVehiculoNotificacion>0)
            {
                // ✅ SIEMPRE INSERTAR - NUNCA ACTUALIZAR
                val queryNot = """
    ...
    suspend fun insertarPaso3LogVehiculo(
        ...
        try {
            ...
            // ✅ DETERMINAR SI TIENE FOTO SEGÚN SI fotoBase64 ES NULL O NO
            val tieneFoto = if (fotoBase64 != null && fotoBase64.isNotEmpty()) 1 else 1
